...
```{r, echo = FALSE}
#This code chunk includes notes from synchronous class, please ignore.  Thanks.
...
First, I have assigned the corresponding names to variables with numerical coding. I have converted birth weight from grams to kilograms, all weights in pounds to kilograms, and family income from hundreds to single units (e.g., 35 to 3500).  I have removed the variables pnumlbw and pnumsga because all observations are zero.
```{r}
baby_df =
  read_csv("./data/birthweight.csv") %>% 
  mutate(
  ...
  select(babysex, bhead, blength, bwt, momwt, everything(), -delwt, -pnumlbw, -pnumsga)
```
