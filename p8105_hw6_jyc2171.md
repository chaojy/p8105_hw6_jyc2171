...
ggplots, I will definitely select babysex, mrace, momwt, bhead, blength,
gaweeks.
...
Based on my univariate analyses of all covariates, the following
variables are statisticall significant at the p \< 0.05 level: babysex,
mrace, momwt, gaweeks, fincome, frace, ppbmi, ppwt, smoken, and wtgain.
Bhead and blength have p values equal to zero - I wonder if these are
collinear variables (since they all kind of measure the same thing). I
will include these anyway because, why not?
...
Next, I will fit the two specified models and perform cross-validation
just for these two models
